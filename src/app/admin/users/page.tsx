  ...
  return (
    <div className="space-y-6">
      ...
      <header className="flex items-center justify-between" role="banner">
        <div>
          <h1 className="text-3xl font-bold" style={{color: tokens.colors.gray[900]}}>Gestion des Utilisateurs</h1>
          <p className="mt-1" style={{color: tokens.colors.gray[600]}}>Administration complète des comptes FACTURA</p>
        </div>
      ...
      {/* Statistiques globales */}
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4" role="region" aria-labelledby="stats-heading">
        <h2 id="stats-heading" className="sr-only">Statistiques globales des utilisateurs</h2>
        <article className="rounded-xl border p-4" style={{backgroundColor: tokens.colors.gray[50], borderColor: tokens.colors.gray[200]}} role="article">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm" style={{color: tokens.colors.gray[600]}}>Total Utilisateurs</span>
            <Users size={16} style={{color: tokens.colors.primary[600]}} aria-hidden="true" />
          </div>
          <div className="text-2xl font-bold" style={{color: tokens.colors.gray[900]}}>{totalUsers}</div>
          <div className="text-xs mt-1" style={{color: tokens.colors.gray[500]}}>{globalStats.activeUsers} actifs (30j)</div>
        </article>

        <article className="rounded-xl border p-4" style={{backgroundColor: tokens.colors.gray[50], borderColor: tokens.colors.gray[200]}} role="article">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm" style={{color: tokens.colors.gray[600]}}>Plans Pro</span>
            <CheckCircle size={16} style={{color: tokens.colors.success[600]}} aria-hidden="true" />
          </div>
          <div className="text-2xl font-bold" style={{color: tokens.colors.success[600]}}>{proUsers}</div>
          <div className="text-xs mt-1" style={{color: tokens.colors.gray[500]}}>{((proUsers / totalUsers) * 100).toFixed(1)}% des utilisateurs</div>
        </article>

        <article className="rounded-xl border p-4" style={{backgroundColor: tokens.colors.gray[50], borderColor: tokens.colors.gray[200]}} role="article">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm" style={{color: tokens.colors.gray[600]}}>Plans Free</span>
            <Users size={16} style={{color: tokens.colors.gray[600]}} aria-hidden="true" />
          </div>
          <div className="text-2xl font-bold" style={{color: tokens.colors.gray[900]}}>{freeUsers}</div>
          <div className="text-xs mt-1" style={{color: tokens.colors.gray[500]}}>{((freeUsers / totalUsers) * 100).toFixed(1)}% des utilisateurs</div>
        </article>

        <article className="rounded-xl border p-4" style={{backgroundColor: tokens.colors.gray[50], borderColor: tokens.colors.gray[200]}} role="article">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm" style={{color: tokens.colors.gray[600]}}>En attente</span>
            <Clock size={16} style={{color: tokens.colors.warning[600]}} aria-hidden="true" />
          </div>
          <div className="text-2xl font-bold" style={{color: tokens.colors.warning[600]}}>{pendingCount}</div>
          <div className="text-xs mt-1" style={{color: tokens.colors.gray[500]}}>Validations requises</div>
        </article>
      </section>

      {/* Filtres et recherche */}
      <section className="rounded-xl border p-4" style={{backgroundColor: tokens.colors.gray[50], borderColor: tokens.colors.gray[200]}} role="search" aria-label="Filtres de recherche des utilisateurs">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            <Search size={20} className="absolute left-3 top-1/2 transform -translate-y-1/2" style={{color: tokens.colors.gray[400]}} aria-hidden="true" />
            <input
              type="text"
      ...
      <section className="rounded-xl border overflow-hidden" style={{backgroundColor: tokens.colors.gray[50], borderColor: tokens.colors.gray[200]}} role="region" aria-labelledby="users-list-heading">
        <div className="px-6 py-4 border-b" style={{backgroundColor: tokens.colors.gray[100], borderColor: tokens.colors.gray[200]}}>
          <div className="flex items-center justify-between">
            <h2 id="users-list-heading" className="font-semibold" style={{color: tokens.colors.gray[900]}}>Liste des utilisateurs</h2>
            <span className="text-sm" style={{color: tokens.colors.gray[500]}}>{profiles?.length || 0} utilisateurs</span>
          </div>
        </div>
