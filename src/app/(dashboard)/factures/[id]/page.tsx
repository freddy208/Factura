...
export default async function FactureDetailPage({
  ...
  return (
    <main className="space-y-6 pb-20 sm:space-y-8">
      {/* Header premium */}
      <section className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-3xl border border-blue-100 p-6 shadow-lg">
        <div className="flex items-center gap-4">
          <Link
            href="/factures"
            className="group p-3 bg-white/80 hover:bg-white rounded-xl transition-all shadow-sm hover:shadow-md border border-white/50"
          >
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900">{invoice.number}</h1>
      ...
      {/* Actions premium */}
      <section className="bg-white rounded-3xl border border-slate-200 p-6 shadow-lg">
        <InvoiceActions
          invoice={invoice}
          profile={profile}
          isPro={isPro}
      ...
      {!isPro && (
        <section className="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 rounded-3xl border border-amber-200 p-6 shadow-lg">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Link
              href="/upgrade"
              className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 px-4 py-2.5 text-sm font-bold text-white transition-all hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
            >
              Passer en Pro
            </Link>
          </div>
      ...
      <section className="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-lg">
        {/* Header bleu premium */}
        <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 px-6 py-8">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-white text-3xl sm:text-4xl font-black mt-2">{invoice.number}</p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-6 px-6 py-8 border-b border-slate-100 sm:grid-cols-2">
        ...
        {/* Dates premium */}
        <div className="grid grid-cols-1 gap-4 px-6 py-6 bg-gradient-to-br from-slate-50 to-gray-50 border-b border-slate-100 sm:grid-cols-2">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-slate-50 to-gray-50 border-b border-slate-200">
                  <th className="text-left text-xs font-bold uppercase tracking-wide py-4 px-4 text-slate-700">
                    Description
                  </th>
                  <th className="text-center text-xs font-bold uppercase tracking-wide py-4 px-2 w-20 text-slate-700">
                    Qté
                  </th>
                  <th className="text-right text-xs font-bold uppercase tracking-wide py-4 px-4 w-32 text-slate-700">
                    Prix unit.
                  </th>
                  <th className="text-right text-xs font-bold uppercase tracking-wide py-4 px-4 w-32 text-slate-700">
                    Total
        ...
        <div className="px-6 py-6 border-t border-slate-100 bg-gradient-to-br from-slate-50 to-gray-50">
          <div className="flex flex-col items-end space-y-3">
            <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
              <div className="flex justify-between w-56 text-sm text-slate-600 mb-2">
              ...
              <div className="flex justify-between w-56 font-black text-slate-900
