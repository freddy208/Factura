  ...
  return (
    <main className="space-y-5 pb-24 sm:space-y-6 sm:pb-8">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <Link
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700
                       text-white font-semibold px-4 py-2.5 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
          >
            <Plus size={18} />
            Nouveau devis
          </Link>
      ...
      {!quotes || quotes.length === 0 ? (
        <section className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-8 text-center shadow-sm">
          <div className="w-16 h-16 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <FileText size={32} className="text-indigo-600" />
          </div>
          <h3 className="font-semibold text-slate-900 text-lg mb-2">Aucun devis</h3>
          <p className="text-slate-500 text-sm mb-6 max-w-md mx-auto">
            Créez votre premier devis et convertissez-le en facture en 1 clic avec notre système intelligent
          </p>
          <Link
            href="/devis/nouveau"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700
                       text-white font-semibold px-6 py-3 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
          >
            <Plus size={16} />
        ...
        <section className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
          <div className="bg-gradient-to-r from-slate-50 to-indigo-50 px-6 py-3 border-b border-slate-100">
          ...
          <div className="divide-y divide-slate-50">
            {quotes.map((quote: any, index: number) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-xl flex items-center
