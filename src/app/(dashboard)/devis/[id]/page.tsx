        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 rounded-lg bg-indigo-500/20 px-3 py-1.5 mb-3">
        ...
        <div className="px-6 py-4 border-t border-slate-100">
          <div className="flex flex-col items-end space-y-2">
            ...
            <div className="flex justify-between w-48 font-bold text-slate-900
              ...
              <span>Total</span>
              <span className="text-indigo-600 text-lg bg-indigo-50 px-2 py-1 rounded-lg">
                {formatCurrency(invoice.total, invoice.currency)}
              </span>
            </div>
          </div>
